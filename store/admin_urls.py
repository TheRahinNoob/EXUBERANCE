...
urlpatterns = [
    ...
    path(
        "products/<int:pk>/attributes/reorder/",
        AdminProductAttributeReorderView.as_view(),
    ),
    path(
        "product-attributes/<int:pav_id>/",
    ...
    path(
        "cms/hot-category-blocks/<int:pk>/items/",
        AdminHotCategoryBlockItemCreateView.as_view(),
    ),
    path(
        "cms/hot-category-blocks/<int:pk>/items/reorder/",
        AdminHotCategoryBlockItemReorderView.as_view(),
    ),
    path(
        "cms/hot-category-blocks/<int:pk>/items/<int:item_id>/",
        AdminHotCategoryBlockItemDeleteView.as_view(),
    ),
    ...
    path(
        "cms/comfort-rails/<int:pk>/image/",
        AdminComfortCategoryRailImageUpdateView.as_view(),
    ),
    path(
        "cms/comfort-rails/<int:pk>/products/",
        AdminComfortCategoryRailProductView.as_view(),
    ),
    path(
        "cms/comfort-rails/<int:pk>/products/<int:product_id>/",
        AdminComfortCategoryRailProductView.as_view(),
    ),
    path(
        "cms/comfort-rails/reorder/",
        AdminComfortCategoryRailReorderView.as_view(),
    ),

    # ---------------- CMS — COMFORT EDITORIAL 🔥 ----------------
    path(
        "cms/comfort-editorial/",
        AdminComfortEditorialBlockListCreateView.as_view(),
    ),
    path(
        "cms/comfort-editorial/<int:pk>/",
        AdminComfortEditorialBlockDetailView.as_view(),
    ),
    path(
        "cms/comfort-editorial/reorder/",
        AdminComfortEditorialBlockReorderView.as_view(),
    ),
]
